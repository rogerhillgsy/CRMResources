...
function changeHeaderTileFormat() {
    ...
    if (Xrm.Page.getControl('header_arup_organisationid').getAttribute().getValue() == null) {
        Xrm.Page.getControl('header_arup_organisationid').setVisible(false);
    }

    if (Xrm.Page.getControl('header_ccrm_frameworkid').getAttribute().getValue() == null) {
        Xrm.Page.getControl('header_ccrm_frameworkid').setVisible(false);
    }
